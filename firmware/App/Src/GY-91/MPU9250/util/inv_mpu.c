...
struct chip_cfg_s {
    ...
    uint8_t fifo_enable;
    /* Matches int32_t enable register. */
    uint8_t int_enable;
 ...
 */
int32_t set_int_enable(uint8_t enable)
{
    uint8_t tmp;
 ...
 *  @return     0 if successful.
 */
int32_t mpu_lp_accel_mode(uint16_t rate)
{
    uint8_t tmp[2];
 ...
 *  @return     0 if successful.
 */
int32_t mpu_get_gyro_reg(int16_t *data, uint32_t *timestamp)
{
    uint8_t tmp[6];
 ...
 *  @return     0 if successful.
 */
int32_t mpu_get_accel_reg(int16_t *data, uint32_t *timestamp)
{
    uint8_t tmp[6];
 ...
 *  @return     0 if successful.
 */
int32_t mpu_get_temperature(int32_t *data, uint32_t *timestamp)
{
    uint8_t tmp[2];
    int16_t raw;
 ...
 *  @return     0 if successful.
 */
int32_t mpu_read_6500_accel_bias(int32_t *accel_bias) {
	uint8_t data[6];
 ...
 *  @return     0 if successful.
 */
int32_t mpu_read_6050_accel_bias(int32_t *accel_bias) {
	uint8_t data[6];
...
int32_t mpu_read_6500_gyro_bias(int32_t *gyro_bias) {
	uint8_t data[6];
 ...
 *  @return     0 if successful.
 */
int32_t mpu_set_gyro_bias_reg(int32_t *gyro_bias)
{
 ...
 *  @return     0 if successful.
 */
int32_t mpu_set_accel_bias_6050_reg(const int32_t *accel_bias) {
    uint8_t data[6] = {0, 0, 0, 0, 0, 0};
 ...
 *  @return     0 if successful.
 */
int32_t mpu_set_accel_bias_6500_reg(const int32_t *accel_bias) {
    uint8_t data[6] = {0, 0, 0, 0, 0, 0};
    int32_t accel_reg_bias[3] = {0, 0, 0};
 ...
 *  @return     0 if successful.
 */
int32_t mpu_get_int_status(int16_t *status)
{
    uint8_t tmp[2];
    if (!st.chip_cfg.sensors)
        return -1;
 ...
 *  @return     0 if successful.
 */
int32_t mpu_read_fifo(int16_t *gyro, int16_t *accel, uint32_t *timestamp,
...
static int32_t accel_self_test(int32_t *bias_regular, int32_t *bias_st)
{
    int32_t jj, result = 0;
...
static int32_t gyro_self_test(int32_t *bias_regular, int32_t *bias_st)
{
    int32_t jj, result = 0;
    uint8_t tmp[3];
...
static int32_t get_st_biases(int32_t *gyro, int32_t *accel, uint8_t hw_test)
{
    uint8_t data[MAX_PACKET_LENGTH];
...
static int32_t accel_6500_self_test(int32_t *bias_regular, int32_t *bias_st, int32_t debug)
{
    int32_t i, result = 0, otp_value_zero = 0;
...
static int32_t gyro_6500_self_test(int32_t *bias_regular, int32_t *bias_st, int32_t debug)
{
    int32_t i, result = 0, otp_value_zero = 0;
...
static int32_t get_st_6500_biases(int32_t *gyro, int32_t *accel, uint8_t hw_test, int32_t debug)
{
    uint8_t data[HWST_MAX_PACKET_LENGTH];
    uint8_t packet_count, ii;
    uint16_t fifo_count;
    int32_t s = 0, read_size = 0, ind;
 ...
 */
int32_t mpu_run_6500_self_test(int32_t *gyro, int32_t *accel, uint8_t debug)
{
 ...
 *  @return     Result mask (see above).
 */
int32_t mpu_run_self_test(int32_t *gyro, int32_t *accel)
{
#ifdef MPU6050
    const uint8_t tries = 2;
    int32_t gyro_st[3], accel_st[3];
 ...
 *  @return     0 if successful.
 */
int32_t mpu_get_compass_reg(int16_t *data, uint32_t *timestamp)
{
#ifdef AK89xx_SECONDARY
    uint8_t tmp[9];
